...
const ManageMenu = () => {
    ...
    const {addMenuItems, IsAddMenuItem} = useMenuAddStore();
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="w-full max-w-md p-3 bg-base-200 rounded-lg shadow-lg">
      ...
      <div className="pt-4">
        <button type="submit" className="btn btn-success w-full">{IsAddMenuItem ? "Adding.." : "Add Menu"}</button>
      </div>
    </form>
  </div>
  )
